    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Hey there, I&apos;m Karan S - a passionate Backend developer, state level chess player,
          and a c,c++,python developer. Welcome to my corner of the
          digital world!
        </Paragraph>
        <Paragraph className=" mt-4">
          Since the early days of my journey, I&apos;ve been captivated by the
          art of crafting exceptional codes. As a developer, I
          thrive on turning lines of code into functional and elegant solutions.
          My goal is to not just create software, but to build best machine learning for different process
          that seamlessly merge work and help for people.
        </Paragraph>
        ...
        <Paragraph className=" mt-4">
          I have a done a research paper on the "WEATHER PREDICTION USING MACHINE LEARNING" and submitted for conference level and got selected for the conference.
